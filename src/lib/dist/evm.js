...
var SMART_ROUTER_ADDRESSES = {
  ...
  [17e3]: "0x16AB999fb9f1fF6633c2b6b1C707721377887921"
};
var V2_ROUTER_ADDRESS = {
  ...
  [17e3]: "0xeB0DAADf31cC744736471520fdc767e7681945b3"
};
...
var MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [17e3]: "0x9b7b1f3d29475f54e31e10a74e04b8437585f6da"
};
var V3_QUOTER_ADDRESSES = {
  ...
  [17e3]: "0x38A5C36FA8c8c9E4649b51FCD61810B14e7ce047"
};
...
var _ApproveAndCall = class {
  ...
  static encodeCallPositionManager(calldatas) {
    invariant2__default.default(calldatas.length > 0, "NULL_CALLDATA");
...
var _SwapRouter = class {
  ...
  static encodeSwaps(anyTrade, options, isSwapAndAdd) {
    ...
    if (options.inputTokenPermit) {
      invariant2__default.default(sampleTrade.inputAmount.currency.isToken, "NON_TOKEN_PERMIT");
  ...
  static swapAndAddCallParameters(trades, options, position, addLiquidityOptions, tokenInApprovalType, tokenOutApprovalType) {
    ...
    if (options.outputTokenPermit) {
      invariant2__default.default(quoteAmountOut.currency.isToken, "NON_TOKEN_PERMIT_OUTPUT");
...
var allGauges = gauges.GAUGES_CONFIG[chains.ChainId.BSC];
...
var getStablePoolsOnChain = createOnChainPoolFactory({
  ...
  getPossiblePoolMetas: ([currencyA, currencyB]) => {
    const poolConfigs = stableSwapSdk.getStableSwapPools(currencyA.chainId);
  ...
  return function createOnChainQuoteProvider({
    ...
    const createGetRoutesWithQuotes = (isExactIn = true) => {
      ...
      return async function getRoutesWithQuote(routes, { blockNumber: blockNumberFromConfig, gasModel, retry: retryOptions, signal }) {
        ...
        const multicallConfigs = multicallConfigsOverride?.[chainId] || BATCH_MULTICALL_CONFIGS[chainId] || BATCH_MULTICALL_CONFIGS[chains.ChainId.ETHEREUM];
        const {
